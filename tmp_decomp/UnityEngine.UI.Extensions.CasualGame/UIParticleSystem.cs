	...
	protected override void OnPopulateMesh(VertexHelper vh)
	{
		...
		for (int i = 0; i < num; i++)
		{
			...
			if (textureSheetAnimation.enabled)
			{
				...
				vector2.y = 1f - (float)Mathf.FloorToInt(num5 / textureSheetAnimation.numTilesX) * textureSheetAnimationFrameSize.y;
